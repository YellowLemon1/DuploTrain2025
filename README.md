...
Instructions:
Install *_TwoPads.ino on to an original ESP32 as it has BT classic. It runs Bluepad32 and sends controller outputs over the serial port.
Install *_XYsticks.ino on to any ESP32 variant (even -S3) it uses BLE to connect to and control the DUPLO Trains
